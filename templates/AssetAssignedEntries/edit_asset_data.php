                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group pname">
                                            <input type="text" class="datepicker1 form-control" name="date_of_assign"  value="<?= isset($AssetAssignedEntries->date_of_assign) ? $AssetAssignedEntries->date_of_assign : '' ?>" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($values->active == 1) { ?>
                                                    <a href="<?= $this->Url->build('/asset-assigned-entries/releaseAsset/' . $values->id . '/' . $values->asset_id) ?>" class="link-warning" style="color: #ef5350 ;" title="Release Asset">
