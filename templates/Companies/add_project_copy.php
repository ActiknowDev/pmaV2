        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group pname">
                                            ...
                                            <input type="text" class="form-control" name="project_name" value="<?= !empty($projects)?$project_name:''; ?>" placeholder="" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group cname">
                                            <input id="tags" class="form-control client" name=
                                            "client_name" value="<?= !empty($projects)?$client:''; ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="icon ft-primary"><i class="fa fa-calendar-alt"></i></span>
                                            <input class="datepicker form-control" type="text"  placeholder="" name="awarded_on" autocomplete="off" value="<?= !empty($projects)?$award:''; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="icon ft-primary"><i class="fa fa-calendar-alt"></i></span>
                                            <input class="datepicker form-control" type="text"  placeholder="" name="due_date" value="<?= !empty($projects)?$due_date:''; ?>" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group amt">
                                            ...
                                            <select name="project_type" id="" class="form-control">
                                                ...
                                                <?php if(!empty($projects)) { echo ($type=='Fixed Price')?'selected':'';} ?>>Fixed</option>
                                                <option value="Hourly" <?php if(!empty($projects)) { echo ($type=='hourly')?'selected':'';}?>>Hourly</option>
                                            </select>
                                            <input type="text" class="form-control text-right" style="width:70px" placeholder="$3000" name="amount" value="<?= !empty($projects)?$amount:'';?>" autocomplete="off" onkeypress="return isareaNumber(event)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group pmgr">
                                            <select name="project_manager_id" class="form-control" id="" style="color:black;">
                                                <option value="">Select Project Manger</option>
                                                <?php foreach($manager as $m): ?>
                                                
                                                <option value="<?= $m->id; ?>" <?php if(!empty($projects)) { echo ($project_manager_id==$m->id)?'selected':'';} ?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group tl">
                                            <select name="tech_lead_id" class="form-control" id="" style="color:black;">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if(!empty($projects)) { echo ($tech_lead_id==$m->id)?'selected':'';} ?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group bd">
                                            <select name="bd_id" class="form-control" id="" style="color:black;">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if(!empty($projects)) { echo ($bd_id==$m->id)?'selected':'';} ?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group res">
                                            <select name="resources[]" class="form-control" multiple id="langOpt">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if(!empty($projects)) { echo (in_array($m->id, $res))?'selected':'';} ?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <label for="">Source</label>
                                                <div class="adon-group res">
                                                  <select name="source" class="form-control">
                                                        <option value="Regular" <?php if(!empty($projects)){ echo ($source=='Regular')?'selected':""; } ?>>Regular</option>
                                                        <option value="External" <?php if(!empty($projects)){ echo ($source=='External')?'selected':""; } ?>>External</option>
                                                  </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" style="margin-top:22px;">
                                                 <button type="submit" name="submit" class="v-btn v-btn-secondary float-right" id="save_project" <?php if(!empty($projects)) { echo 'disabled="true"'; } ?>><span>Save Project</span></button>
                                             </div>
                                        </div>
                                    </div> 
                             </div>
                            ...
                            <table class="table table-default" id="table_data">
                                ...
                                <tbody id="rowm<?= $m['id'];?>">
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>
                                            <a href="#" class="icon mtask" data-toggle="modal" data-target="#add_task" onclick="taskValue(<?= $m['id'];?>)" title="Add Task"><i class="fa fa-plus"></i></a>
                    ...
                    <div class="block">
                        ...
                        <div class="content table-responsive">
                            <table class="table table-default table-sm allocation-table">
                                ...
                                <tbody>
                                   <?php if(!empty($projects)):
                                        $i = 1;foreach($resourceList as $rl): ?>
                                    <tr>
                                        <td><?= $i; ?></td>
                                        <td><?= $rl['title'];?></td>
                                        ...
                                        foreach($rl['res'] as $r): ?>
                                        <td>
                                            <input type="text" class="form-control aloc-input changeTime hrs_<?= $rl['id'];?>" data-id="<?= $rl['id'];?>" value="<?= $r['time'];?>" data-user="<?= $r['id'];?>" placeholder="hrs">
                                            
                                            <input type="text" class="form-control aloc-input disabled" disabled placeholder="hrs" value="30">
                                        </td>
                                        <?php $hrs += $r['time'];endforeach; endif; ?>
                                        <td>
                                            <input type="text"  value="<?= $hrs;?>" class="form-control aloc-input disabled totalmgr_<?= $rl['id'];?>" disabled placeholder="hrs">
                    ...
                    <div class="block">
                        <div class="header">
                            <h4 class="title">Payment History <a href="#" data-target="#add_payment_received" data-toggle="modal" class="v-btn v-btn-primary float-right"><i class="fa fa-plus"></i><span>Add Payment</span></a></h4></h4>
                        </div>
                        <div class="content table-responsive">
        ...
        <div class="content">
                    ...
                    <label for="">Company Name</label>
                     <div class="adon-group">
                      <span class="icon ft-primary"><i class="fa fa-building"></i></span>
                        ...
                        <input type="text" class="form-control" name="company_name"  placeholder="" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-12">
                    <label for="">Client Name</label>
                     <div class="adon-group clname">
                        ...
                        <input type="text" class="form-control" name="client_name" placeholder="" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="adon-group">
                        <input type="text" name="country_code" class="form-control text-center" placeholder="" value="+91" autocomplete="off" style="border-right: 1px solid #eee; width:45px;">
...
<div class="modal fade" tabindex="-1" role="dialog" id="add_payment_received">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="v-btn v-btn-base cancel" data-dismiss="modal">Close</button>
        <button type="submit" name="submit" class="v-btn v-btn-primary" id="savepayment">Add To Payment History</button>
      </div>
    </div>
  </div>
  <?= $this->Form->end() ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="edit_payment">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="v-btn v-btn-base cancel" data-dismiss="modal">Close</button>
        <button type="submit" name="submit" class="v-btn v-btn-primary" id="editpayment">Update Payment History</button>
      </div>
    </div>
  </div>
  <?= $this->Form->end() ?>
       ...
       $.ajax({
         ...
         success: function( response ) {
           ...
           $(".close").click();
                    ...
                    html += '<td><select name="mstatus" class="form-control mstatus" onchange="changeStatus(\'miles\',\''+url+'\','+response.id+')"><option value="Yet to start">Yet to start</option><option value="Inprogress">In progress</option><option value="Completed">completed</option></select></td>';
         ...
         success: function( response ) {
           ...
           $(".close").click();
            document.getElementById("rowm"+response.id).remove();
                    ...
                    html += '<td>'+response.due_date+'</td>';
                    html += '<td>$'+response.amount+'</td>';
                    html += '<td><select name="mstatus" class="form-control mstatus" onchange="changeStatus(\'miles\',\''+url+'\','+response.id+')"><option value="">Yet to start</option><option value="">In progress</option><option value="">completed</option></select></td>';
                    html += '<td><a href="#" class="icon mtask" data-toggle="modal" data-target="#add_task" onclick="taskValue('+response.id+')" title="Add Task"><i class="fa fa-plus"></i></a><a href="#" class="icon" data-toggle="modal" data-target="#edit_milestone" onclick="passValue(\'edit\','+response.id+')"> <i class="fa fa-pencil-alt"></i> </a><a href="#" class="icon delete-milestone" data-id="'+response.id+'" onclick="passValue(\'delete\','+response.id+')"> <i class="fa fa-trash-alt"></i> </a></td>';
                    html += '</tr></tbody>';
...
function isareaNumber(evt) 
  { 
    var charCode = (evt.which) ? evt.which : evt.keyCode; if (charCode != 190 && charCode != 46 && charCode > 31 && (charCode < 48 || charCode > 57)) return false; return true; 
  } 
       ...
       $.ajax({
         ...
         success: function( response ) {
           ...
           $(".close").click();
                    ...
                    html += '<td><select name="mstatus" class="form-control mstatus" onchange="changeStatus(\'payment\',\''+url+'\','+response.id+')"><option value="Billed">Billed</option><option value="Paid">Paid</option><option value="Estimated">Estimated</option></select></td>';
                    html += '<td><a href="#" class="icon" data-toggle="modal" data-target="#edit_payment" onclick="passPayment(\'edit\','+response.id+')"> <i class="fa fa-pencil-alt"></i> </a><a href="#" class="icon" onclick="passPayment(\'delete\','+response.id+')"> <i class="fa fa-trash-alt"></i> </a></td>';
                    
                    $('#payment_data').prepend(html);

                    var html = '<input type="hidden" name="ptid[]" id="p_'+response.id+'" value="'+response.id+'">';
       ...
       $.ajax({
         ...
         success: function( response ) {
           ...
           $(".close").click();
                    ...
                    html += '<td>'+response.due_date+'</td>';
                    html += '<td>-</td>';
                    html += '<td><select name="mstatus" class="form-control mstatus" onchange="changeStatus(\'tasks\',\''+url+'\','+response.id+')"><option value="Yet to start">Yet to start</option><option value="Inprogress">In progress</option><option value="Completed">completed</option></select></td>';
