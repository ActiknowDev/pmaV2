                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if($miles): foreach($payments as $p): ?>
                                        ...
                                        <div class="adon-group pname">
                                            <input type="text" class="form-control" name="project_name" value="<?= $project_name;?>" placeholder="" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="icon ft-primary"><i class="fa fa-calendar-alt"></i></span>
                                            <input class="datepicker form-control" type="text"  placeholder="" name="awarded_on" value="<?= $award;?>" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="icon ft-primary"><i class="fa fa-calendar-alt"></i></span>
                                            <input class="datepicker form-control" type="text"  placeholder="" name="due_date" value="<?= $due_date;?>" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group amt">
                                            ...
                                            <select name="project_type" id="" class="form-control">
                                                <option value="Fixed Price" <?php if($type=='Fixed Price') echo 'selected';?>>Fixed</option>
                                                <option value="Hourly" <?php if($type=='hourly') echo 'selected';?>>Hourly</option>
                                            </select>
                                            <input type="text" class="form-control text-right" style="width:70px" placeholder="$3000" value="<?= $amount;?>" name="amount" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group pmgr">
                                            <select name="project_manager_id" class="form-control" id="" style="color:black;">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if($project_manager_id == $m->id) echo 'selected';?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group tl">
                                            <select name="tech_lead_id" class="form-control" id="" style="color:black;">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if($tech_lead_id == $m->id) echo 'selected';?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group bd">
                                            <select name="bd_id" class="form-control" id="" style="color:black;">
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if($bd_id == $m->id) echo 'selected';?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="adon-group res">
                                            <select name="resources[]" class="form-control" multiple id="langOpt">
                                               ...
                                               foreach($resource as $m): ?>
                                                ...
                                                <option value="<?= $m->id; ?>" <?php if(in_array($m->id,$res)) echo 'selected';?>><?= $m->name ;?></option>
                                               <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" style="margin-top:22px;">
                                                 <button type="submit" name="submit" class="v-btn v-btn-secondary float-right" id="save_project"><span>Update Project</span></button>
                                             </div>
                                        </div>
                                    </div> 
                             </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="edit_payment">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="v-btn v-btn-base cancel" data-dismiss="modal">Close</button>
        <button type="submit" name="submit" class="v-btn v-btn-primary" id="edtpayment">Update Payment History</button>
      </div>
    </div>
  </div>
  <?= $this->Form->end() ?>
