                    ...
                    <table class="table table-light nowrap table-sm  block" id="example1" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr id="tr<?= $p['id'] ?>">
                                ...
                                <td>
                                    <input class="tgl tgl-light change-status" id="<?= $p['id']; ?>" type="checkbox"
...
$('#sortBy').on('change', function() {
    ...
    var target_url = "<?= $this->Url->build('/companies/activeProject/') ?>" + manager_id;
    if (target_url != null) {
        window.location.href = target_url;
    } else {
        window.location.href = "<?= $this->Url->build('/companies/activeProject/') ?>"
    }
});
