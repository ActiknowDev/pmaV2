                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" name="emp_id" class="form-control" placeholder="" value="<?= @$user_data['id'] ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" name="name" class="form-control" placeholder="" value="<?=@$user_data['name'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" class="form-control " name="guardian_name" value="<?= @$user_data['emp_detail']['guardian_name'] ?>" required placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input required type="text" readonly name="dob" class="form-control datepicker" placeholder="" name="<?= @$user_data['emp_detail']['dob'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                                    class="fa fa-calendar-alt"></i></span>
                                            <input required readonly type="text" name="doj" class="form-control datepicker" placeholder="" name="<?= @$user_data['emp_detail']['doj'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input required type="email" class="form-control " value="<?= @$user_data['emp_detail']['email']?>" name="email" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input type="text" class="form-control " name="mobile_no" name="<?= @$user_data['emp_detail']['mobile_no']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input type="text" name="phone_no" class="form-control " value="<?=@$user_data['emp_detail']['phone_no']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input type="text" value="<?=@$user_data['company']?>" class="form-control " name="company_name" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">CTC</label>
                                        <div class="adon-group">
                                            <input type="text" name="ctc" class="form-control " value="<?=@$user_data['emp_detail']['ctc']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input type="text" class="form-control " name="location" value="<?= @$user_data['emp_detail']['location']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" class="form-control " name="pan_no" value="<?=@$user_data['emp_detail']['pan_no']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" class="form-control " name="ntc_perd" value="<?=@$user_data['emp_detail']['ntc_perd']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group">
                                            <input type="text" class="form-control " name="bond" value="<?=@$user_data['emp_detail']['bond']?>" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?=@$user_data['emp_detail']['house_no_prmnt']?>" name="house_no_prmnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Locality</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['locality_prmnt']?>" name="locality_prmnt"class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">City</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['city_prmnt']?>" name="city_prmnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">State</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['state_prmnt']?>" name="state_prmnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Zip</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['zip_prmnt']?>" name="zip_prmnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Phone No.</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['phone_prmnt']?>" name="phone_prmnt" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">House No.</label>
                                                <input name="house_no_prsnt" value="<?=@$user_data['emp_detail']['house_no_prsnt']?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Locality</label>
                                                <input name="locality_prsnt" value="<?=@$user_data['emp_detail']['locality_prsnt']?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">City</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['city_prsnt']?>" name="city_prsnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">State</label>
                                                <input type="text" value="<?=@$user_data['emp_detail']['state_prsnt']?>" name="state_prsnt" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Zip</label>
                                                <input name="zip_prsnt" value="<?=@$user_data['emp_detail']['zip_prsnt']?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Phone No.</label>
                                                <input name="phone_prsnt" value="<?=@$user_data['emp_detail']['phone_prsnt']?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="content table-responsive">
                            ...
                            <table class="table table-default table-sm mb-3">
                                ...
                                <tbody id="goverment_add_more_tbody">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control" name="ref_gov_name[]" value="<?=@$key['ref_name']?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_gov_org[]" value="<?=@$key['ref_org']?>" placeholder="Organization">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_gov_desgn[]" value="<?=@$key['ref_desigtion']?>" placeholder="Designation">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_gov_address[]" value="<?=@$key['ref_address']?>" placeholder="Address">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_gov_contact[]" value="<?=@$key['ref_contact']?>" placeholder="Contact Number">
                                        </td>
                                        <td><a href="#" data-id="<?=$key['id']?>" data-name="" ><i class="fa fa-edit"></i></a></td>
                                    </tr>
                                    <?php endif; ?>
                                     <?php } ?>
                            ...
                            <table class="table table-default table-sm">
                                ...
                                <tbody id="ref_last_add_body">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control" name="ref_last_name[]" value="<?=@$key['ref_name']?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_last_org[]" value="<?=@$key['ref_org']?>" placeholder="Organization">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_last_desgn[]" value="<?=@$key['ref_desigtion']?>" placeholder="Designation">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_last_addrss[]" value="<?=@$key['ref_address']?>" placeholder="Address">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ref_last_contact[]" value="<?=@$key['ref_contact']?>" placeholder="Contact Number">
                                        </td>
                                    </tr>
                            ...
                            <div class="block">
                                ...
                                <div class="content table-responsive">
                                    <div class="container">
                                        ...
                                        <?php if($key['ref_flag']=='IDP'): ?>

                                            <li>
                                                <a href="#" ><?= end(explode('/',$key['prf_file'])) ?></a>
                                                <span class="icon icon-xs ft-dark">
                                                    <i data-id="<?= $key['id'] ?>" class="fa fa-trash"></i>
                                                </span>
                                            </li>
                                ...
                                <tbody id="education_tbody">
                                    ...
                                    <tr>
                                        <td>
                                           ...
                                           <?= $this->form->select('education_type[]',['10th'=>'10th','12th'=>'12th','UG'=>'UG','PG'=>'PG'],['default'=>$key['ac_type'],'class'=>'form-control input-sm']) ?>
                                        ...
                                        <td>
                                            <input type="text" name="education_org[]" class="form-control input-sm" value="<?=$key['ac_org']?>">
                                        </td>
                                        <td>
                                            <input type="text" name="education_Education[]" value="<?= $key['ac_education']?>" class="form-control input-sm">
                                        </td>
                                        <td>
                                            <input type="text" name="education_passout[]" value="<= $key['']?>" class="form-control input-sm">
                                        </td>
                                        <td>
                                            <p>
                                                <a href="#">Marksheet</a>
                                        ...
                                        <td>
                                             ...
                                             <a href="#" onclick="return false;" class="icon icon-xs">
