            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="heading ft-secondary">
                        <span class="icon"><i class="fa fa-user-tie"></i></span>Employee Detail
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <input type="hidden" value="edit" name="edit-profile">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <?= $this->Form->control('doj', ['autocomplete' => false, 'required' => true, 'label' => false, 'class' => 'form-control', 'type' => 'date', 'default' => @$user_data['emp_detail']['doj']]); ?>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <?= $this->Form->control('dol', ['autocomplete' => false, 'label' => false, 'class' => 'form-control', 'type' => 'date', 'default' => @$user_data['dol']]); ?>
                                ...
                                <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <input type="text" value="<?= @$user_data['company_name'] ?>" class="form-control " name="company_name" autocomplete="off" placeholder="" >
                                        </div>
                                    </div>
                                </div> -->
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <?= $this->Form->control('prev_appraisal', ['autocomplete' => false, 'label' => false, 'class' => 'form-control', 'type' => 'date', 'default' => @$user_data['emp_detail']['prev_appraisal']]); ?>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="adon-group"> <span class="icon ft-primary"><i
                                            ...
                                            <?= $this->Form->control('next_appraisal', ['autocomplete' => false, 'label' => false, 'class' => 'form-control', 'type' => 'date', 'default' => @$user_data['emp_detail']['next_appraisal']]); ?>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <?= $this->Form->text("note", [
                                            "class" => "form-control",
                                            "autocomplete" => "off",
                                            "value" => $user_data['emp_detail']['note']??'m',
                                            "id" => "note"
                                        ]) ?>
                    ...
                    <div class="block">
                        ...
                        <div class="content table-responsive">
                            ...
                            <table class="table table-default table-sm mb-3">
                                ...
                                <tbody id="goverment_add_more_tbody">
                                    <?php if (!empty($user_data['emp_ref'])) : ?>
                                            ...
                                            <?php if ($key['ref_flag'] == 'GOV') : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#"
                                                        onclick="load_modal_edit_ref_gov(this);"
                                                        data-toggle="modal"
                                                        data-id="<?= $key['id'] ?>"
                                                        data-name="<?= $key['ref_name'] ?>"
                                                        data-org="<?= $key['ref_org'] ?>"
                                                        data-desgn="<?= $key['ref_desigtion'] ?>"
                                                        data-address="<?= $key['ref_address'] ?>"
                                                        data-contact="<?= $key['ref_contact'] ?>"
                                                        data-target="#edit_gov_ref">
                                    ...
                                    <div class="container">
                                        ...
                                        <ul class="uploaded-file-list">
                                            ...
                                            <a href="<?= $this->Url->webroot('img/ADP/' . @$key['prf_file']) ?>"
                                                target="_blank" download><?= @end(explode('/', substr($key['prf_file'], 2))) ?></a>
                                            ...
                                            <?php if (isset($user_data['emp_proof'])) : ?>
                                                <?php foreach ($user_data['emp_proof'] as $key) : ?>
                                                    ...
                                                    <?php if ($key['prf_flag'] == 'IDP') : ?>
                                                        ...
                                                        <?php
                                                            $filePath = substr($key['prf_file'], 2);

                                                            $fileArray = explode('/', $filePath);
                                                            $fileName = end($fileArray);

                                                            $deleteArray = explode('/', $key['prf_file']);
                                                            $deleteFileName = end($deleteArray);
                                                        ?>
                                ...
                                <div class="content table-responsive">
                                    <div class="container">
                                        ...
                                        <ul class="uploaded-file-list">
                                            ...
                                            <a href="<?= $this->Url->webroot('img/ADP/' . @$key['prf_file']) ?>"
                                                download><?= @end(explode('/', substr($key['prf_file'], 2))) ?></a>
                                            <span
                                                data-id="<?= $key['id'] . ',' . end(explode('/', $key['prf_file'])) ?>"
                                                class="icon icon-xs ft-dark identity_proof_delete"
                                                style="cursor: pointer;">
                        ...
                        <div class="content table-responsive table-sm">
                            <table>
                                ...
                                <tbody id="education_tbody">
                                    ...
                                    <?php if (!empty($user_data['emp_acad'])) : ?>
                                        ...
                                        <?php foreach ($user_data['emp_acad'] as $key) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        <?php if (!empty($key['acc_mark'])) : ?>

                                                            <?php $markFile = basename($key['acc_mark']); ?>

                                                            <a href="<?= $this->Url->webroot($key['acc_mark']) ?>"
                                                            target="_blank">
                                                            ...
                                                            <span class="icon icon-xs academic-delete"
                                                                data-id="<?= $key['id'] ?>"
                                                                data-flag="mark">
                                                    ...
                                                    <p>
                                                        <?php if (!empty($key['acc_certificate'])) : ?>

                                                            <?php $certFile = basename($key['acc_certificate']); ?>

                                                            <a href="<?= $this->Url->webroot($key['acc_certificate']) ?>"
                                                            target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#"
                                                    data-id="<?= $key['id'] ?>"
                                                    data-type="<?= $key['ac_type'] ?>"
                                                    data-org="<?= $key['ac_org'] ?>"
                                                    data-educ="<?= $key['ac_education'] ?>"
                                                    data-passout="<?= $key['ac_passout'] ?>"
                                                    onclick="load_modal_education(this);"
                                                    class="icon icon-xs"
                                                    data-toggle="modal"
                                                    data-target="#edit_education">
                        ...
                        <div class="content table-responsive table-sm">
                            <div class="row form-group">
                                ...
                                <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                                    ...
                                    <input type="file" name="passbook" class="form-control" value="">
                                    <?php
                                    if ($user_data['employee_other_detail']->passbook != "") :
                                    ?>
                                    <a href="<?= $this->Url->webroot('img/ADP/' . $user_data['employee_other_detail']->passbook) ?>"
                                        target="_blank"
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    ...
                                    <?php if (!empty($user_data['employee_other_detail']) && !empty($user_data['employee_other_detail']->passbook)) : ?>

                                        <?php $passbookFile = $user_data['employee_other_detail']->passbook; ?>

                                        <a href="<?= $this->Url->webroot('img/ADP/' . $passbookFile) ?>"
                                            target="_blank"
                                            download>

                                            <?= basename($passbookFile) ?>
